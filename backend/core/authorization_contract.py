from backend.schemas.authorization_contract import (
...
class AuthorizationContractBuilder:
    def build(
        ...
        provided_resources: dict | None = None,
        granted_capabilities: list[str] | None = None,
        available_external_ai: list[str] | None = None,
        protected_paths: list[str] | None = None,
    ) -> AuthorizationContract:
        caps = granted_capabilities or CAPABILITY_PRESETS.get(
            authorization_mode, CAPABILITY_PRESETS["standard"]
        )
