  ...
  "plan": [
    {
      ...
      "required_capabilities": ["read_files", "run_shell"],
      "verification_method": "如何验证这一步成功",
      "failure_fallback": "失败后的备用方案"
    }
  ],
  "total_steps": 4,
...
5. 考虑失败的备选方案
6. 必须读取 Goal Contract 的 final_goal 和 success_criteria
7. 必须读取 Authorization Contract 的 granted_capabilities，只规划已授权能力能完成的动作
8. full_autonomy 下应主动加入必要的外部 AI 求助、视觉评审、自动修复和自验证步骤"""
        ...
        try:
            ...
            return {
                "plan": [{
                    ...
                    "verification_method": "check evidence and final report",
                    "failure_fallback": "ask for more information or use external_ai",
                }],
                "total_steps": 1,
                "error": str(e),
            }
